...
export default function login() {
    ...
    return (
        <div className="flex-col justify-center px-12 py-12 mx-auto w-full max-w-md">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p className="mt-10 text-center text-sm/6 text-gray-500">
                    Not a member? <Link to='/register' className="font-semibold text-indigo-600 hover:text-indigo-500">Register</Link>
                </p>
            </div>
        </div>
    )
