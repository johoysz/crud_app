...
export default function register() {
    return (
        <div className="flex-col justify-center px-12 py-15 mx-auto w-full max-w-md">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form className="space-y-6" action="#" method="POST">
                    <div>
                        ...
                        <div className="mt-2">
                            <input type="text" name="text" id="text" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 border" />
                        </div>
                    </div>
                    <div>
